...
$Src = Join-Path $Root "src\Switch2FfsResponder.java"
$Build = Join-Path $Root "build\switch2_responder"
...
$ClassFiles = Get-ChildItem -LiteralPath $Classes -Recurse -Filter "Switch2FfsResponder*.class" |
