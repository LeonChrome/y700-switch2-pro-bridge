...
- `rate <20..1000>` persists the HID report-loop rate in NVS; the default is 125 Hz.
...
- `rumble hdtest` and `rumble hold <ms>` send the verified 33-byte HD rumble stream to the Pro2 BLE rumble characteristic.
