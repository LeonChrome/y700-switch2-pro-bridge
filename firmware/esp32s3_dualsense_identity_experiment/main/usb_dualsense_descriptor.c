...
#define DS5_AUDIO_RENDER_DESC_LEN DUALSENSE_USB_UAC1_2CH_DESC_LEN
#else
...
#define DS5_UAC1_AUDIO_RENDER_DESCRIPTOR(_stridx, _epout, _epsize) \
    ...
    DS5_AUDIO_CONTROL_INTERFACE, 0x02, TUSB_CLASS_AUDIO, \
    AUDIO_FUNCTION_SUBCLASS_UNDEFINED, AUDIO_FUNC_PROTOCOL_CODE_UNDEF, 0x00, \
    ...
    0x00, 0x02, U16_TO_U8S_LE(0x0003), 0x00, 0x00, \
    ...
    AUDIO_FORMAT_TYPE_I, 0x02, DS5_AUDIO_BYTES_PER_SAMPLE, \
...
static const uint8_t s_ds5_configuration_descriptor[] = {
    ...
    DS5_UAC1_AUDIO_RENDER_DESCRIPTOR(STRID_AUDIO_INTERFACE,
                                     DS5_AUDIO_EP_OUT,
                                     DUALSENSE_USB_UAC1_2CH_PACKET_SIZE),
#endif
...
_Static_assert(DS5_AUDIO_RENDER_DESC_LEN == DUALSENSE_USB_UAC1_2CH_DESC_LEN,
