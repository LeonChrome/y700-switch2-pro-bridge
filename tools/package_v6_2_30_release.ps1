...
$ReleaseRoot = Join-Path $RepoRoot "release\v6.2.30"
...
$ReadmeSource = Join-Path $RepoRoot "tools\release_notes_v6_2_30.zh-CN.md"
$DotnetRoot = Join-Path $RepoRoot "work\dotnet"

function Write-Step([string]$Name, [string]$Value) {
    Write-Output "[V6_2_30_PACKAGE] $Name=$Value"
}
