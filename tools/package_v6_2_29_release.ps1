...
$ReleaseRoot = Join-Path $RepoRoot "release\v6.2.29"
...
$ReadmeSource = Join-Path $RepoRoot "tools\release_notes_v6_2_29.zh-CN.md"
$DotnetRoot = Join-Path $RepoRoot "work\dotnet"

function Write-Step([string]$Name, [string]$Value) {
    Write-Output "[V6_2_29_PACKAGE] $Name=$Value"
}
