# v5 5 usb descriptor dump hid audio uac1 4ch ds5like
...
~~~text
serial=V55UAC1_4CH
build=work/build/v5_5_dualsense_identity/hid_audio_uac1_4ch_ds5like/esp32s3_dualsense_identity_experiment.elf
...
0020: 01 00 04 33 00 00 00 09 24 03 03 02 03 00 01 00
0030: 09 04 01 00 00 01 02 00 04 09 04 01 01 01 01 02
0040: 00 04 07 24 01 01 01 01 00 0B 24 02 01 04 02 10
0050: 01 80 BB 00 09 05 02 09 80 01 01 00 00 07 25 01
...
| `0x0049` | 11 | CS_INTERFACE | subtype=0x02 channels=4 bits=16 sample_rate=48000 |
| `0x0054` | 9 | ENDPOINT | ep=0x02 OUT isochronous attributes=0x09 max_packet=384 interval=1 |
...
| audio | version=UAC1, channels=4, sample_rate=48000 |
