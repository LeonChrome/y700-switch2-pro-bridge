# v5 5 usb descriptor dump hid only
...
~~~text
serial=V55HIDONLY
build=work/build/v5_5_dualsense_identity/hid_only/esp32s3_dualsense_identity_experiment.elf
...
~~~text
0000: 09 02 29 00 01 01 00 80 32 09 04 00 00 02 03 00
0010: 00 04 09 21 11 01 00 01 22 91 00 07 05 81 03 40
0020: 00 01 07 05 01 03 40 00 01
~~~

| Offset | Length | Type | Detail |
| ---: | ---: | --- | --- |
| `0x0000` | 9 | CONFIGURATION | wTotalLength=41 bNumInterfaces=1 attributes=0x80 max_power=100mA |
| `0x0009` | 9 | INTERFACE | interface=0 alt=0 endpoints=2 class=0x03 subclass=0x00 protocol=0x00 iInterface=4 |
| `0x0012` | 9 | HID | bcdHID=0x0111 report_length=145 |
| `0x001B` | 7 | ENDPOINT | ep=0x81 IN interrupt attributes=0x03 max_packet=64 interval=1 |
| `0x0022` | 7 | ENDPOINT | ep=0x01 OUT interrupt attributes=0x03 max_packet=64 interval=1 |
...
| Check | Result |
| --- | --- |
| wTotalLength | declared=41, actual=41, valid=true |
| bNumInterfaces | declared=1, unique=1, valid=true |
