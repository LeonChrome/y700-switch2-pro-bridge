# v5 5 usb descriptor dump hid audio streaming alt0 only
...
~~~text
serial=V55ASALT0
build=work/build/v5_5_dualsense_identity/hid_audio_streaming_alt0_only/esp32s3_dualsense_identity_experiment.elf
...
~~~text
0000: 09 02 44 00 03 01 00 80 32 09 04 00 00 00 01 01
0010: 00 04 09 24 01 00 01 09 00 01 01 09 04 01 00 00
0020: 01 02 00 04 09 04 02 00 02 03 00 00 05 09 21 11
0030: 01 00 01 22 91 00 07 05 81 03 40 00 01 07 05 01
0040: 03 40 00 01
~~~

| Offset | Length | Type | Detail |
| ---: | ---: | --- | --- |
| `0x0000` | 9 | CONFIGURATION | wTotalLength=68 bNumInterfaces=3 attributes=0x80 max_power=100mA |
...
| `0x001B` | 9 | INTERFACE | interface=1 alt=0 endpoints=0 class=0x01 subclass=0x02 protocol=0x00 iInterface=4 |
| `0x0024` | 9 | INTERFACE | interface=2 alt=0 endpoints=2 class=0x03 subclass=0x00 protocol=0x00 iInterface=5 |
| `0x002D` | 9 | HID | bcdHID=0x0111 report_length=145 |
| `0x0036` | 7 | ENDPOINT | ep=0x81 IN interrupt attributes=0x03 max_packet=64 interval=1 |
| `0x003D` | 7 | ENDPOINT | ep=0x01 OUT interrupt attributes=0x03 max_packet=64 interval=1 |
...
| Check | Result |
| --- | --- |
| wTotalLength | declared=68, actual=68, valid=true |
...
| audio | version=UAC1, channels=0, sample_rate=48000 |
