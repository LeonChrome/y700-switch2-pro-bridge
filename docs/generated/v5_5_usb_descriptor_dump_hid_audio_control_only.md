# v5 5 usb descriptor dump hid audio control only
...
~~~text
serial=V55ACONLY
build=work/build/v5_5_dualsense_identity/hid_audio_control_only/esp32s3_dualsense_identity_experiment.elf
...
~~~text
0000: 09 02 3A 00 02 01 00 80 32 09 04 00 00 00 01 01
0010: 00 04 08 24 01 00 01 08 00 00 09 04 01 00 02 03
0020: 00 00 05 09 21 11 01 00 01 22 91 00 07 05 81 03
0030: 40 00 01 07 05 01 03 40 00 01
~~~

| Offset | Length | Type | Detail |
| ---: | ---: | --- | --- |
| `0x0000` | 9 | CONFIGURATION | wTotalLength=58 bNumInterfaces=2 attributes=0x80 max_power=100mA |
| `0x0009` | 9 | INTERFACE | interface=0 alt=0 endpoints=0 class=0x01 subclass=0x01 protocol=0x00 iInterface=4 |
| `0x0012` | 8 | CS_INTERFACE | subtype=0x01 bcdADC=0x0100 |
| `0x001A` | 9 | INTERFACE | interface=1 alt=0 endpoints=2 class=0x03 subclass=0x00 protocol=0x00 iInterface=5 |
| `0x0023` | 9 | HID | bcdHID=0x0111 report_length=145 |
| `0x002C` | 7 | ENDPOINT | ep=0x81 IN interrupt attributes=0x03 max_packet=64 interval=1 |
| `0x0033` | 7 | ENDPOINT | ep=0x01 OUT interrupt attributes=0x03 max_packet=64 interval=1 |
...
| Check | Result |
| --- | --- |
| wTotalLength | declared=58, actual=58, valid=true |
