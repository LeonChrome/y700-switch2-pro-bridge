# v5 5 usb descriptor dump hid composite dummy interface
...
~~~text
serial=V55DUMMY00
build=work/build/v5_5_dualsense_identity/hid_composite_dummy_interface_class_00/esp32s3_dualsense_identity_experiment.elf
...
~~~text
0000: 09 02 32 00 02 01 00 80 32 09 04 00 00 00 FF 00
0010: 00 00 09 04 01 00 02 03 00 00 04 09 21 11 01 00
0020: 01 22 91 00 07 05 81 03 40 00 01 07 05 01 03 40
0030: 00 01
~~~

| Offset | Length | Type | Detail |
| ---: | ---: | --- | --- |
| `0x0000` | 9 | CONFIGURATION | wTotalLength=50 bNumInterfaces=2 attributes=0x80 max_power=100mA |
| `0x0009` | 9 | INTERFACE | interface=0 alt=0 endpoints=0 class=0xFF subclass=0x00 protocol=0x00 iInterface=0 |
| `0x0012` | 9 | INTERFACE | interface=1 alt=0 endpoints=2 class=0x03 subclass=0x00 protocol=0x00 iInterface=4 |
| `0x001B` | 9 | HID | bcdHID=0x0111 report_length=145 |
| `0x0024` | 7 | ENDPOINT | ep=0x81 IN interrupt attributes=0x03 max_packet=64 interval=1 |
| `0x002B` | 7 | ENDPOINT | ep=0x01 OUT interrupt attributes=0x03 max_packet=64 interval=1 |
...
| Check | Result |
| --- | --- |
| wTotalLength | declared=50, actual=50, valid=true |
| bNumInterfaces | declared=2, unique=2, valid=true |
...
| string indices | max=4, descriptor_count=5, valid=true |
| audio | version=none, channels=0, sample_rate=0 |

## `hid_composite_dummy_interface_class_ef`

~~~text
serial=V55DUMMYEF
build=work/build/v5_5_dualsense_identity/hid_composite_dummy_interface_class_ef/esp32s3_dualsense_identity_experiment.elf
